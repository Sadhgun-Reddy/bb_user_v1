...
const CATERER = {
    ...
    isVerified: true,
    coverImage: 'https://images.unsplash.com/photo-1555244162-803834f70033?auto=format&fit=crop&q=80&w=1600',
    cuisineTags: 'North Indian • Continental • Mughlai',
    yearsInBusiness: '12 Years in Business',
    rating: 4.9,
    reviews: 120,
    eventsCompleted: '500+',
    about: 'At Royal Feast Caterers, we believe that every event is a story waiting to be told through food. With over a decade of experience in crafting unforgettable culinary experiences, our team of master chefs specializes in bringing authentic flavors to your special occasions. From intimate gatherings to grand weddings, we source only the freshest ingredients and employ traditional cooking methods to ensure every dish is a masterpiece.',
    certifications: [
...
const DISHES = [
    ...
    },
    {
        ...
        price: '₹280/plate',
        isVeg: true,
        image: 'https://images.unsplash.com/photo-1631452180519-c014fe1a71e7?auto=format&fit=crop&q=80&w=600'
    },
    {
        id: 'D03',
        title: 'Dal Makhani',
    ...
    <div className="relative w-full max-w-7xl mx-auto h-[400px] rounded-[2.5rem] overflow-hidden shadow-sm feature-hero mt-4">
        ...
        <div className="absolute bottom-8 left-8 md:left-12 flex flex-col gap-3 z-10 w-full md:w-2/3 pr-8">
            <div className="flex items-center gap-3">
                <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight drop-shadow-lg">{caterer.name}</h1>
                {caterer.isVerified && (
                    <div className="w-8 h-8 rounded-full bg-[#ef9d2a] flex items-center justify-center shrink-0 shadow-lg" title="Verified Caterer">
...
const SignatureDishCard = ({ dish }) => (
    <div className="bg-white rounded-[2rem] shadow-sm border border-stone-100 overflow-hidden flex flex-col group hover:shadow-md transition-all">
        ...
        <div className="p-5 flex flex-col gap-2 flex-1 bg-white relative z-20">
            <h4 className="text-lg font-bold text-stone-900 line-clamp-1 group-hover:text-[#ef9d2a] transition-colors">{dish.title}</h4>
    ...
    <div className="sticky top-24 flex flex-col gap-6">
        ...
        <div className="bg-orange-50 rounded-[2rem] p-6 border border-orange-100/50">
            <div className="flex flex-col gap-2 mb-4">
                <span className="text-[#ef9d2a] font-black uppercase tracking-widest text-xs">Deals & Offers</span>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-orange-100">
                ...
                <p className="text-sm text-stone-500 font-medium">Book before Nov 30th for events in Dec-Jan. Minimum guest count 100.</p>
            </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] shadow-sm border border-stone-100 overflow-hidden">
            <div className="p-6 pb-4">
                ...
                <ul className="flex flex-col gap-3">
                    {['FSSAI Registered Facility', '100% Staff Vaccinated', 'Daily Temperature Checks', 'Regular Pest Control'].map((item, idx) => (
        ...
        <div className="bg-slate-900 rounded-[2rem] p-6 text-center transform transition-all shadow-xl shadow-slate-900/10">
            ...
            <p className="text-slate-400 font-medium text-sm mb-6">Get a customized quote for your event within 24 hours.</p>
        ...
        <div className="min-h-screen bg-[#fcfaf8] font-['Plus_Jakarta_Sans',sans-serif] selection:bg-[#ef9d2a]/30 pb-24">
            ...
            <header className="bg-white border-b border-stone-100 h-20 flex items-center px-6 lg:px-12 justify-between sticky top-0 z-50">
                <div className="flex items-center gap-2">
                    <Link to="/" className="w-10 h-10 rounded-full bg-[#ef9d2a] flex items-center justify-center shadow-lg shadow-orange-500/20">
                        <Utensils className="w-5 h-5 text-white" />
                    </Link>
                    <span className="font-black text-xl tracking-tight text-slate-900">BookBawarchi</span>
                </div>
                <nav className="hidden md:flex items-center gap-8">
                    <Link to="/caterers" className="text-sm font-bold text-stone-500 hover:text-stone-900 transition-colors">← Back to Search</Link>
                </nav>
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-12">
                        ...
                        <section className="scroll-mt-32" id="overview">
                            ...
                            <div className="flex flex-wrap gap-4 mt-8">
                                {CATERER.certifications.map((cert, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className="flex items-center gap-3 p-3 pr-6 rounded-xl bg-white border border-stone-100 shadow-sm">
                                            <div className={`w-10 h-10 rounded-lg ${cert.bg} ${cert.color} flex items-center justify-center`}>
                        ...
                        <section className="scroll-mt-32" id="menu">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <button className="text-[#ef9d2a] font-bold text-sm hover:underline">View Full Menu</button>
                            </div>
