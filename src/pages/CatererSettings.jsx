...
const INITIAL_DATA = {
    ...
    about: 'We specialize in large-scale wedding events and corporate functions. With over 15 years of experience, our team of expert chefs delivers authentic flavors with modern presentation.',
};
...
const SettingsHeader = () => (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full mb-8">
        <div className="flex flex-col gap-1">
            ...
            <p className="text-stone-500 font-medium">Manage your caterer identity and operational preferences.</p>
        </div>
...
const AlertBanner = () => (
    <div className="w-full bg-orange-50 rounded-2xl p-4 flex items-center gap-4 mb-8 border border-orange-100/50">
        ...
        <div className="flex flex-col flex-1">
            ...
            <span className="text-sm font-medium text-slate-600">Your FSSAI and Registration documents are currently under review.</span>
        </div>
...
const BasicInfoTab = ({ formData, setFormData }) => {
    return (
        <div className="flex flex-col gap-10 mt-8 animate-in fade-in duration-500">

            {/* Visual Media Section */}
            <div className="flex flex-col gap-4">
                <h3 className="text-lg font-black text-stone-900 hidden">Media</h3> {/* Optional Section Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div className="col-span-1 flex flex-col gap-3">
                        ...
                        <div className="aspect-square w-full sm:max-w-[240px] md:max-w-none border-2 border-dashed border-slate-200 rounded-3xl bg-slate-50/50 hover:bg-orange-50/30 hover:border-[#ef9d2a]/30 transition-all flex flex-col items-center justify-center cursor-pointer group">
                            ...
                            <span className="text-sm font-bold text-stone-600 group-hover:text-[#ef9d2a] transition-colors">Upload Logo</span>
                    ...
                    <div className="col-span-1 md:col-span-2 flex flex-col gap-3">
                        ...
                        <div className="aspect-[2/1] w-full border-2 border-dashed border-slate-200 rounded-3xl bg-slate-50/50 hover:bg-orange-50/30 hover:border-[#ef9d2a]/30 transition-all flex flex-col items-center justify-center cursor-pointer group relative overflow-hidden">
                            <div className="flex flex-col items-center justify-center z-10 relative pointer-events-none">
                                ...
                                <span className="text-sm font-bold text-stone-600 group-hover:text-[#ef9d2a] transition-colors">Drag and drop or browse</span>
                                <span className="text-xs font-medium text-slate-400 mt-1">Ratio 2:1 (1200x600px recommended)</span>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                        <label className="text-sm font-bold text-stone-900 ml-2">Business Name <span className="text-red-500">*</span></label>
                        <input
                            type="text"
                ...
                <div className="bg-white rounded-[2.5rem] p-6 lg:p-10 shadow-sm border border-slate-100 flex flex-col">
                    ...
                    {activeTab === 'location' && (
                        <div className="py-20 flex flex-col items-center justify-center text-center animate-in fade-in">
                            ...
                            <p className="text-slate-500 font-medium">Configure your service area and delivery radius here.</p>
                        </div>
                    )}
                    ...
                    {activeTab === 'operations' && (
                        <div className="py-20 flex flex-col items-center justify-center text-center animate-in fade-in">
                            ...
                            <p className="text-slate-500 font-medium">Set your weekly availability and holiday schedules.</p>
                        </div>
                    )}
                    ...
                    {activeTab === 'verification' && (
                        <div className="py-20 flex flex-col items-center justify-center text-center animate-in fade-in">
                            ...
                            <p className="text-slate-500 font-medium">Manage FSSAI licenses, tax documents, and payout accounts.</p>
                        </div>
                    )}
