      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-2 px-6 py-2.5 rounded-full text-sm transition-all whitespace-nowrap ${
              isActive
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between ml-2 mb-1">
            ...
            <span className="text-xs font-bold text-slate-400">{formData.about.length}/500</span>
          </div>
          <textarea
