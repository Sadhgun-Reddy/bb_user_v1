            ...
            <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
                    ...
                    {!isSubmitted ? (
                        ...
                        <div className="flex flex-col animate-fade-in">
                            ...
                            <div className="mt-8 text-center pt-2">
                                <button onClick={() => navigate('/login')} className="inline-flex items-center gap-2 text-sm font-bold text-stone-500 hover:text-[#ef9d2a] transition-colors group">
                        ...
                        <div className="flex flex-col items-center text-center animate-fade-in py-6">
                            ...
                            <p className="text-sm font-medium text-stone-500">
                                ...
                                <button onClick={() => setIsSubmitted(false)} className="text-[#ef9d2a] font-bold hover:underline">
                                    Click to resend
                                </button>
                            </p>
                        </div>
                ...
                <div className="absolute bottom-8 left-0 right-0 text-center animate-fade-in z-10">
                    <p className="text-sm text-stone-500 font-medium">
                        Need help? <a href="#" className="font-bold text-[#1b160d] hover:text-[#ef9d2a] underline decoration-stone-300 hover:decoration-[#ef9d2a] transition-colors">Contact Support</a>
                    </p>
                </div>
