...
const MOCK_GALLERY = [
    { id: 'img-1', src: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=800&aspect=1', category: 'Events', isCover: true },
    { id: 'img-2', src: 'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=800&aspect=1', category: 'Kitchen', isCover: false },
    { id: 'img-3', src: 'https://images.unsplash.com/photo-1414235077428-33898bd12284?w=800&aspect=1', category: 'Food', isCover: false },
    { id: 'img-4', src: 'https://images.unsplash.com/photo-1547573854-74d2a71d0826?w=800&aspect=1', category: 'Events', isCover: false },
    { id: 'img-5', src: 'https://images.unsplash.com/photo-1512485800893-b08ec1ea59b1?w=800&aspect=1', category: 'Decorations', isCover: false },
    { id: 'img-6', src: 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=800&aspect=1', category: 'Team', isCover: false },
    { id: 'img-7', src: 'https://images.unsplash.com/photo-1528605248644-14dd04022da1?w=800&aspect=1', category: 'Events', isCover: false },
    { id: 'img-8', src: 'https://images.unsplash.com/photo-1628294895950-9805252327bc?w=800&aspect=1', category: 'Kitchen', isCover: false },
];
...
const GalleryHeader = () => (
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
            ...
            <p className="text-base font-medium text-slate-500 mt-1">Upload and organize your portfolio photos</p>
        </div>

        <div className="flex items-center gap-6">
            <div className="flex flex-col gap-2 items-end">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">75 / 200 Photos</span>
...
const FilterNavigation = ({ activeTab, setActiveTab }) => (
...
const MediaCard = ({ item, isSelected, toggleSelection }) => (
    <div
    ...
    >
        ...
        {/* Hover Gradient */}
        <div className={`absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 ${isSelected ? 'opacity-10' : ''}`}></div>
        ...
        {!isSelected && (
            <div className="absolute top-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                >
                    <Star className="w-4 h-4" fill={item.isCover ? "currentColor" : "none"} strokeWidth={2.5} />
                </button>
            </div>
        )}
        ...
        <div className="absolute bottom-4 left-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col gap-1">
            <span className="text-white text-xs font-bold px-2.5 py-1 backdrop-blur-md bg-black/40 rounded-full">{item.category}</span>
        </div>
    </div>
);


const FloatingActionDock = ({ selectedCount, clearSelection }) => {
