...
const LoginPage = () => {
    ...
    const handleLogin = (e) => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            // Route based on dummy logic or default to user dashboard
            if (email.includes('admin') || email.includes('caterer')) {
                navigate('/caterer');
            } else {
                navigate('/dashboard');
            }
                ...
                <div className="w-full max-w-[960px] rounded-[2rem] lg:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px] z-10 bg-white animate-fade-in">
                    ...
                    <div className="md:w-5/12 bg-[#ef9d2a]/10 p-10 flex flex-col justify-center relative">
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            <div>
                                <h2 className="text-3xl lg:text-4xl font-bold text-[#1b160d] mb-2 leading-tight">Welcome back!</h2>
                                <p className="text-stone-600 text-base mb-10 font-medium">Log in to manage your catering needs.</p>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-stone-500 text-sm font-medium">Keep all your booking requests in one secure place.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-stone-500 text-sm font-medium">Create a shortlist of your favorite vendors for future events.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-stone-500 text-sm font-medium">Unlock special recipes curated by top local chefs.</p>
                                        </div>
                                    </div>
                    ...
                    <div className="md:w-7/12 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white relative z-10">
                        <div className="max-w-sm mx-auto w-full">
                            ...
                            <h1 className="text-2xl lg:text-3xl font-bold text-[#1b160d] mb-8 text-center md:text-left">Login to your account</h1>
                            ...
                            <div className="relative flex items-center justify-center mb-6">
                                ...
                                <span className="absolute bg-white px-3 text-sm text-stone-400 font-medium">or login with email</span>
                            </div>
                            ...
                            <form onSubmit={handleLogin} className="flex flex-col gap-5">
                                ...
                                <label className="block">
                                    <span className="block text-sm font-bold text-stone-700 mb-2 pl-1">Email Address</span>
                                    <input
                                        type="email"
                                        value={email}
                                        onChange={(e) => setEmail(e.target.value)}
                                        required
                                        className="w-full h-12 px-5 rounded-full border border-stone-200 bg-stone-50 text-[#1b160d] placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#ef9d2a]/50 focus:border-[#ef9d2a] transition-all font-medium"
                                ...
                                <label className="block">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            required
                                            className="w-full h-12 px-5 pr-12 rounded-full border border-stone-200 bg-stone-50 text-[#1b160d] placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#ef9d2a]/50 focus:border-[#ef9d2a] transition-all font-medium"
                                ...
                                <div className="flex justify-end mt-1">
                                    <a href="#" className="text-sm font-bold text-stone-500 hover:text-[#ef9d2a] transition-colors">
                                        Forgot password?
                                    </a>
                                </div>
                            ...
                            <div className="mt-8 text-center space-y-4">
                                <p className="text-sm font-medium text-stone-600">
                                    ...
                                    <a href="#" className="font-bold text-[#ef9d2a] hover:underline decoration-2 underline-offset-2">Sign up</a>
                                </p>
                                <div className="pt-4 border-t border-stone-100">
                                    <p className="text-sm font-medium text-stone-600">
                                        Are you a business?{' '}
                                        <a href="/caterer" className="font-bold text-[#1b160d] hover:text-[#ef9d2a] transition-colors inline-flex items-center gap-1">
