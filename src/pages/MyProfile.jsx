...
const ProfileHeader = () => (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full mb-8">
        <div className="flex flex-col gap-1">
            ...
            <p className="text-stone-500 font-medium">Manage your personal information and preferences.</p>
        </div>
    ...
    <div className="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-transparent w-full">
        ...
        <div className="flex items-start gap-8 mb-8">
            ...
            <div className="flex flex-col justify-center py-4">
                <h3 className="text-lg font-black text-stone-900 leading-tight block sm:hidden">Profile Photo</h3> {/* Mobile context */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
                ...
                <span className="text-xs font-semibold text-slate-400 ml-2 mt-1">Email cannot be changed directly for security.</span>
            </div>
    ...
    <div className="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-transparent w-full mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            {addresses.map(address => {
                ...
                return (
                    <div key={address.id} className="flex flex-col justify-between border border-slate-100 rounded-[1.5rem] p-6 hover:border-[#ef9d2a]/30 transition-colors group relative bg-[#fcfaf8]/50">
                        {/* Upper Block */}
