...
const RECIPE_DATA = {
    ...
    description: "A rich and aromatic preparation of basmati rice and chicken, cooked on dum with saffron and whole spices. This heirloom recipe brings the authentic taste of the Nizam's kitchen to your home.",
    category: {
        main: 'Recipes',
        sub: 'Indian',
        type: 'Main Course'
    ...
    difficulty: 'Medium',
    serves: 4,
    image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&q=80&w=2400&h=1000',
    chef: {
        name: 'Royal Caterers',
    ...
    steps: [
        {
            ...
            description: 'In a large bowl, mix chicken with yogurt, ginger-garlic paste, red chili powder, turmeric, biryani masala, half of the fried onions, mint, coriander, lemon juice, and salt. Let it marinate for at least 2 hours.'
        },
        {
            id: 2,
            title: 'Cook the Rice',
            description: 'Boil water with whole spices (bay leaf, cloves, cardamom, cinnamon) and salt. Add the soaked rice and cook until it is 70% done. The grain should still have a slight bite to it. Drain the water and set aside.',
            image: 'https://images.unsplash.com/photo-1516684732162-798a0062be99?auto=format&fit=crop&q=80&w=800&h=400'
        },
        {
            id: 3,
            title: 'Layering (Dum)',
            description: 'In a heavy-bottomed pot, spread the marinated chicken evenly at the bottom. Layer the 70% cooked rice over the chicken. Sprinkle the remaining fried onions, chopped mint, coriander, saffron milk, and ghee over the rice.'
        },
        {
            id: 4,
            title: 'Slow Cooking',
            description: 'Seal the pot with dough or a tight lid with a cloth. Cook on high heat for 5 minutes, then lower the flame to the lowest setting and cook for 25-30 minutes. Turn off the heat and let it rest for another 10 minutes before opening.'
        },
        {
            id: 5,
            title: 'Serve Hot',
            description: 'Gently fluff the rice from one side to mix the layers slightly. Serve hot with raita and mirchi ka salan.'
        }
    ]
};
            ...
            <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
                <div className="flex items-center justify-between h-20">
                    ...
                    <nav className="hidden md:flex flex-1 justify-end items-center gap-8 pr-8">
                        ...
                        <a href="/recipes" className="text-sm font-bold text-[#ef9d2a]">Recipes</a>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-16 animate-fade-in-up">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
                ...
                <div className="flex items-center gap-2 text-sm text-stone-500 mb-6 font-medium">
                    <a href="/recipes" className="hover:text-stone-800 transition-colors">{data.category.main}</a>
                    <ChevronRight className="w-4 h-4" />
                    <span className="hover:text-stone-800 transition-colors cursor-pointer">{data.category.sub}</span>
                    <ChevronRight className="w-4 h-4" />
            ...
            <div className="lg:col-span-5 flex flex-col justify-center items-start lg:items-end">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 w-full max-w-sm">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        />
                        <div>
                            <p className="text-xs uppercase tracking-wider text-stone-500 font-bold mb-1">Recipe By</p>
                    ...
                    <button className="w-full h-12 flex items-center justify-center gap-2 rounded-full bg-white border-2 border-stone-200 hover:border-[#ef9d2a] hover:text-[#ef9d2a] transition-all text-sm font-bold text-stone-800 group">
                        ...
                        <ArrowUpRight className="w-4 h-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" strokeWidth={3} />
                    </button>
                </div>
            </div>
            ...
            <div className="bg-[#fdf8f0] rounded-3xl p-8 sticky top-28 border border-[#ef9d2a]/10 shadow-sm">
                ...
                <ul className="space-y-4">
                    {ingredients.map((ing, idx) => (
                        <li key={idx} className="flex items-start gap-3 pb-3 border-b border-[#ef9d2a]/10 last:border-0 last:pb-0">
                ...
                <div className="mt-8 pt-6 border-t border-[#ef9d2a]/10">
                    <div className="flex items-center justify-between bg-white p-2.5 rounded-2xl shadow-sm border border-stone-100">
                        <span className="text-sm font-bold text-stone-500 pl-3 uppercase tracking-wider">Portions</span>
                        <div className="flex items-center gap-3">
                            <button
            ...
            <div className="bg-white border-2 border-[#ef9d2a]/20 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden shadow-xl shadow-orange-500/5">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                    <div className="max-w-2xl">
                        <h2 className="text-3xl lg:text-4xl font-black text-[#1b160d] mb-4 tracking-tight">Love this recipe?</h2>
                        <p className="text-stone-600 text-lg font-medium leading-relaxed">
                            Skip the cooking and get this authentic dish prepared perfectly for your next family gathering or corporate event by <strong className="text-stone-900 border-b-2 border-[#ef9d2a]/50">{chefName}</strong>.
                        </p>
                    </div>
                    <div className="flex-shrink-0 w-full md:w-auto">
                        <button className="w-full md:w-auto bg-[#ef9d2a] hover:bg-[#d98a1e] text-white font-bold text-lg px-10 py-4 rounded-full shadow-lg shadow-orange-500/30 transition-all transform hover:-translate-y-1 active:translate-y-0 flex items-center justify-center gap-3 group">
                            ...
                            <Mail className="w-5 h-5 group-hover:rotate-12 transition-transform" strokeWidth={2.5} />
                        </button>
                    </div>
                </div>
