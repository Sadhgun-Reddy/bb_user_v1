    ...
    <div className="flex items-center justify-between mb-12 relative px-2">
      ...
      {steps.map((step) => (
        <div key={step.num} className="relative z-10 flex flex-col items-center gap-2">
          ...
          <span
            className={`text-[10px] sm:text-xs font-bold uppercase tracking-wider absolute -bottom-7 w-max transition-colors ${
              currentStep >= step.num ? 'text-[#ef9d2a]' : 'text-stone-400'
            }`}
          >
            {step.label}
          </span>
