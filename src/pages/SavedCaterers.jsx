                ...
                <div className="p-8 flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-xs font-bold text-stone-500 uppercase tracking-wider ml-1">Event Date</label>
                        ...
                        {/* Guest Count */}
                        <div className="flex flex-col gap-2">
                            <label className="text-xs font-bold text-stone-500 uppercase tracking-wider ml-1">Guests</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    {/* Message Area */}
                    <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-stone-500 uppercase tracking-wider ml-1">Additional Details</label>
                        <div className="relative">
...
export default function SavedCaterersPage() {
    ...
    const filteredList = savedList.filter(caterer =>
    ...
    return (
        <div className="w-full relative animate-in fade-in duration-500">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
                <div className="flex flex-col gap-2">
                    <h1 className="text-3xl md:text-4xl font-black text-stone-900 tracking-tight">Saved Caterers</h1>
                    <p className="text-stone-500 font-medium text-lg">Manage your shortlisted catering options.</p>
                </div>
            ...
            {filteredList.length > 0 ? (
                ...
                <div className="w-full flex flex-col items-center justify-center py-32 bg-white rounded-[3rem] border border-dashed border-stone-200 mt-4">
                    ...
                    <p className="text-stone-500 font-medium text-lg max-w-sm text-center mb-8">
                        {searchQuery ? 'No results match your search criteria.' : 'Start exploring and save your favorite vendors to shortlist them here.'}
                    </p>
                    {!searchQuery && (
                        <Link to="/caterers" className="px-8 py-4 rounded-full bg-stone-900 text-white font-black hover:bg-stone-800 transition-colors shadow-lg">
                            Browse Directory
                        </Link>
                    )}
                </div>
